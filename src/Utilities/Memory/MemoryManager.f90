module MemoryManagerModule
  ...
  subroutine deallocate_str(sclr, name, mem_path)
    ...
    logical(LGP) :: found
    ! -- code
    if (.not.associated(sclr)) then !PAR
      return !PAR
    endif !PAR
  ...
  subroutine deallocate_str1d(astr, name, mem_path)
    ...
    logical(LGP) :: found
    ! -- code
    if (.not.associated(astr)) then !PAR
      return !PAR
    endif !PAR
  ...
  subroutine deallocate_int1d(aint, name, mem_path)
    ...
    integer(I4B) :: ipos
    ! -- code
    if (.not.associated(aint)) then !PAR
      return !PAR
    endif !PAR
    !
  ...
  subroutine deallocate_dbl1d(adbl, name, mem_path)
    ...
    integer(I4B) :: ipos
    ! -- code
    if (.not.associated(adbl)) then !PAR
      return !PAR
    endif !PAR
    !
    ! -- process optional variables
 ...
 subroutine mem_get_ptr(name, mem_path, mt) !PAR
! ******************************************************************************
...
! ------------------------------------------------------------------------------
    ...
    do i = 1, nipos
      ...
      if(trim(mt%name) == trim(name)) then
        if(trim(mt%path) == trim(mem_path)) then
...
subroutine setval_logical(logicalsclr, name, mem_path) !PAR
! ******************************************************************************
! Get information for a variable.
! ******************************************************************************
!
...
! ------------------------------------------------------------------------------
 ...
 subroutine setval_int(intsclr, name, mem_path) !PAR
! ******************************************************************************
! Get information for a variable.
! ******************************************************************************
!
...
! ------------------------------------------------------------------------------
 ...
 subroutine setval_dbl(dblsclr, name, mem_path) !PAR
! ******************************************************************************
! Get information for a variable.
! ******************************************************************************
!
...
! ------------------------------------------------------------------------------
 ...
 subroutine setval_int1d(aint, name, mem_path) !PAR
! ******************************************************************************
! Get information for a variable.
! ******************************************************************************
!
    ...
    select case(mti%memitype)
      ...
      case(iadbl1d)
        ...
        if (.not.associated(mti%adbl1d)) then
          write(*,*) '@@@@@ NOT ASSOCIATED: "'//trim(mti%name)//'" "'//trim(mti%path)//'"', mti%isize
        endif
        do i = 1, isizei
