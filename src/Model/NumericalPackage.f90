module NumericalPackageModule
  ...
  type :: NumericalPackageType
    ...
    !
    logical, pointer                                   :: p_ishalo => null() !< flag for labeling this package as halo !PAR
  contains
    procedure :: set_names
...
! ------------------------------------------------------------------------------
    ...
    !
    call mem_allocate(this%p_ishalo, 'P_ISHALO', this%memoryPath) !PAR
    !
    ! -- initialize
    this%id = 0
    this%inunit = 0
